...
var BluetoothSerial = (function (_super) {
    ...
    /**
       ...
       * @returns {Observable<any>} Subscribe to connect, unsubscribe to disconnect.
       */
    BluetoothSerial.prototype.connect = /**
       * Connect to a Bluetooth device
       * @param {string} macAddress_or_uuid Identifier of the remote device
       * @returns {Observable<any>} Subscribe to connect, unsubscribe to disconnect.
       */
    function (macAddress_or_uuid) { return; };
    /**
    ...
    /**
       ...
       * @returns {Observable<any>} Subscribe to connect, unsubscribe to disconnect.
       */
    BluetoothSerial.prototype.connectInsecure = /**
       * Connect insecurely to a Bluetooth device
       * @param {string} macAddress Identifier of the remote device
       * @returns {Observable<any>} Subscribe to connect, unsubscribe to disconnect.
       */
    function (macAddress) { return; };
    /**
    ...
    /**
       ...
       * @returns {Promise<any>}
       */
    BluetoothSerial.prototype.disconnect = /**
       * Disconnect from the connected device
       * @returns {Promise<any>}
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise when data has been written
       */
    BluetoothSerial.prototype.write = /**
       * Writes data to the serial port
       * @param {any} data ArrayBuffer of data
       * @returns {Promise<any>} returns a promise when data has been written
       */
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise that contains the available bytes
       */
    BluetoothSerial.prototype.available = /**
       * Gets the number of bytes of data available
       * @returns {Promise<any>} returns a promise that contains the available bytes
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise with data from the buffer
       */
    BluetoothSerial.prototype.read = /**
       * Reads data from the buffer
       * @returns {Promise<any>} returns a promise with data from the buffer
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.readUntil = /**
       * Reads data from the buffer until it reaches a delimiter
       * @param {string} delimiter string that you want to search until
       * @returns {Promise<any>} returns a promise
       */
    function (delimiter) { return; };
    /**
    ...
    /**
       ...
       * @returns {Observable<any>} returns an observable.
       */
    BluetoothSerial.prototype.subscribe = /**
       * Subscribe to be notified when data is received
       * @param {string} delimiter the string you want to watch for
       * @returns {Observable<any>} returns an observable.
       */
    ...
    /**
       ...
       * @returns {Observable<any>} returns an observable
       */
    BluetoothSerial.prototype.subscribeRawData = /**
       * Subscribe to be notified when data is received
       * @returns {Observable<any>} returns an observable
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise when completed
       */
    BluetoothSerial.prototype.clear = /**
       * Clears data in buffer
       * @returns {Promise<any>} returns a promise when completed
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.list = /**
       * Lists bonded devices
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.isEnabled = /**
       * Reports if bluetooth is enabled
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.isConnected = /**
       * Reports the connection status
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.readRSSI = /**
       * Reads the RSSI from the connected peripheral
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.showBluetoothSettings = /**
       * Show the Bluetooth settings on the device
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.enable = /**
       * Enable Bluetooth on the device
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<any>} returns a promise
       */
    BluetoothSerial.prototype.discoverUnpaired = /**
       * Discover unpaired devices
       * @returns {Promise<any>} returns a promise
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Observable<any>} Returns an observable
       */
    BluetoothSerial.prototype.setDeviceDiscoveredListener = /**
       * Subscribe to be notified on Bluetooth device discovery. Discovery process must be initiated with the `discoverUnpaired` function.
       * @returns {Observable<any>} Returns an observable
       */
    function () { return; };
    ...
    /**
       ...
       * @param {string} newName Desired name of device
       */
    BluetoothSerial.prototype.setName = /**
       * Sets the human readable device name that is broadcasted to other devices
       * @param {string} newName Desired name of device
       */
    function (newName) { };
    ...
    /**
       ...
       * @param {number} discoverableDuration Desired number of seconds device should be discoverable for
       */
    BluetoothSerial.prototype.setDiscoverable = /**
       * Makes the device discoverable by other devices
       * @param {number} discoverableDuration Desired number of seconds device should be discoverable for
       */
    function (discoverableDuration) { };
